                                    ...
                                    <div class="d-flex order-lg-2">
                                        ...
                                        <div class="dropdown d-flex profile-1">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                                ...
                                                <?php if (!route_has('antrian')) : ?>
                                                    <a class="dropdown-item" href="<?= route('antrian') ?>">
                                                        <i class="dropdown-icon fe fe-file"></i> Antrian Pasien
                                                    </a>
                                                <?php endif ?>
                ...
                <div class="sticky">
                    ...
                    <div class="app-sidebar">
                        <div class="side-header">
                            ...
                            {{-- light --}}
                            <img src="{{ asset(settings()->get(set_admin('app.foto_light_mode'))) }}" class="header-brand-img toggle-logo" alt="logo">

                            {{-- dark --}}
                            <img src="{{ asset(settings()->get(set_admin('app.foto_dark_mode'))) }}" class="header-brand-img light-logo" alt="logo">

                            {{-- dark landscape --}}
                            <img src="{{ asset(settings()->get(set_admin('app.foto_dark_landscape_mode'))) }}" class="header-brand-img light-logo1" alt="logo"> -->

                                <img src="<?= asset($setting['logo_white_landscape']) ?>" altSrc="<?= asset('assets/template/admin/logo.png') ?>" onerror="this.src = $(this).attr('altSrc')" style="max-height: 53px;" class="header-brand-img light-logo1" alt="logo">
                                <img src="<?= asset($setting['logo_white']) ?>" altSrc="<?= asset('assets/template/admin/logo-grid.png') ?>" onerror="this.src = $(this).attr('altSrc')" style="max-height: 53px;" class="header-brand-img light-logo" alt="logo">
                                <img src="<?= asset($setting['logo_landscape']) ?>" altSrc="<?= asset('assets/template/admin/logo.png') ?>" onerror="this.src = $(this).attr('altSrc')" style="max-height: 53px;" class="header-brand-img desktop-logo" alt="logo">
                                <img src="<?= asset($setting['logo']) ?>" altSrc="<?= asset('assets/template/admin/logo-grid.png') ?>" onerror="this.src = $(this).attr('altSrc')" style="max-height: 53px;" class="header-brand-img toggle-logo" alt="logo">
                            </a>
                            <!-- LOGO -->
                        </div>
                        <div class="main-sidemenu">
                            ...
                            <ul class="side-menu">
                                ...
                                <li class="slide">
                                    <a class="side-menu__item <?= route_active_class('pasien', 'active') ?>" data-bs-toggle="slide" href="<?= route('pasien') ?>">
                                        <i class="side-menu__icon fas fa-user"></i>
                                        <span class="side-menu__label">Pasien</span>
                                    </a>
                                </li>

                                <li class="slide">
                                    <a class="side-menu__item <?= route_active_class('antrian', 'active') ?>" data-bs-toggle="slide" href="<?= route('antrian') ?>">
