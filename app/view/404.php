...
<head>
    ...
    <meta name="description" content="Sash – Bootstrap 5  Admin & Halaman Utama Template">
    <meta name="author" content="Spruko Technologies Private Limited">
    <meta name="keywords" content="admin,admin dashboard,admin panel,admin template,bootstrap,clean,dashboard,flat,jquery,modern,responsive,premium admin template,responsive admin,ui,ui kit.">

    <!-- FAVICON -->
    <link rel="shortcut icon" type="image/x-icon" href="<?= asset('assets/template/admin/images/brand/favicon.ico') ?>" />
...
<body class="">
    ...
    <div class="login-img">
        ...
        <div id="global-loader">
            <img src="<?= asset('assets/template/admin/images/loader.svg') ?>" class="loader-img" alt="Loader">
        </div>
        <!-- End GLOBAL-LOADER -->
                ...
                <div class="container text-center">
                    <div class="error-template">
                        ...
                        <h5 class="error-details">
                            Mohon Maaf, halaman yang anda tuju tidak tersedia. Terima Kasih.
                        </h5>
                        <div class="text-center">
                            <a class="btn btn-secondary mt-5 mb-5" href="<?= base_url() ?>"> <i class="fa fa-long-arrow-left"></i> Back to Home </a>
                        </div>
                    </div>
                </div>
            </div>
